...
if cpf:
    ...
    if not cliente_info.empty:
        ...
        interesses_lista = eval(interesses)  # Converte a string de interesses em uma lista
        # Contar a frequência de cada interesse
        interesse_contagem = {interesse: 1 for interesse in interesses_lista}
